...
function Hero() {
  return (
    <section
      id="top"
      className="relative min-h-screen pt-24 md:pt-32 px-6 md:px-12 flex flex-col justify-center noise overflow-hidden"
    >
      <CosmicSystem />
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
        ...
        <div className="relative z-10 order-2 lg:order-1">
          ...
          >
            We are a technology consulting firm that designs, builds, and deploys AI products,
            custom software, cloud platforms, and automation systems for startups and enterprises -
...
function WhatWeDo() {
  const pillars = [
    {
      t: "AI & Automation",
      d: "LLM applications, agents, and workflow automation that replace repetitive operations.",
      icon: "✦",
      link: "/services#03",
    },
    {
      t: "Custom Software",
      d: "Web and mobile products engineered for scale, speed, and reliability.",
      icon: "⌘",
      link: "/services#01",
    },
    {
      t: "Cloud & Data",
      d: "Resilient infrastructure, data pipelines, and analytics on AWS, GCP, and Azure.",
      icon: "⎈",
      link: "/services#04",
    },
    {
      t: "Security & DevOps",
      d: "Hardened systems, CI/CD, observability, and continuous compliance.",
      icon: "⌖",
      link: "/services#05",
    },
  ];
        ...
        <div className="grid md:grid-cols-12 gap-8 md:gap-10 items-end mb-10 md:mb-16">
          ...
          <div className="md:col-span-5">
            <p className="text-[color:var(--muted-foreground)] text-base leading-relaxed">
              Big Bang Tech Solutions is a full-stack technology partner. We help companies launch
              new digital products, modernize existing systems, and put AI into production - without
            ...
            <Reveal key={p.t} delay={i * 0.06}>
              <Link to={p.link} className="block h-full group">
                <div className="surface-card p-7 h-full transition-all duration-300 group-hover:-translate-y-2 group-hover:border-[color:var(--gold)]/40 cursor-pointer">
                  <div className="text-3xl text-[color:var(--gold)] mb-6 font-display group-hover:scale-110 transition-transform origin-left">
                    {p.icon}
                  </div>
                  <h3 className="font-display text-xl font-semibold group-hover:text-[color:var(--gold)] transition-colors">
                    {p.t}
                  </h3>
                  <p className="mt-3 text-[15px] text-[color:var(--muted-foreground)] leading-relaxed group-hover:text-white/80 transition-colors">
                    {p.d}
                  </p>
                </div>
              </Link>
...
const STORY = [
  {
    n: "01",
    t: "Innovation",
    d: "Research-driven prototyping for products that didn't exist yesterday.",
  },
  {
    n: "02",
    t: "Automation",
    d: "Replacing repetitive labor with composable, observable systems.",
  },
  { n: "03", t: "AI", d: "Foundation models and agents embedded into the workflows that matter." },
  {
    n: "04",
    t: "Cloud",
    d: "Multi-region infrastructure architected for resilience and quiet scale.",
  },
  {
    n: "05",
    t: "Transformation",
    d: "Re-platforming legacy systems into modern digital organizations.",
  },
];
    ...
    <section className="relative px-6 md:px-12 py-20 md:py-32 bg-[color:var(--space-ink)] noise section-divider">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16 md:mt-24 relative">
          {STORY.map((s, i) => (
            <div key={s.n} className="sticky" style={{ top: `${120 + i * 18}px` }}>
              <motion.article
              ...
              >
                <div className="md:col-span-2 font-display text-2xl text-[color:var(--gold)]">
                  {s.n}
                </div>
                <div className="md:col-span-7">
                  <h3 className="text-section !text-5xl md:!text-6xl">{s.t}</h3>
                  <p className="mt-6 text-[color:var(--muted-foreground)] max-w-lg text-lg">
                    {s.d}
                  </p>
                </div>
                <div className="md:col-span-3 flex items-end justify-end">
                  <div className="w-32 h-32 rounded-full border border-[color:var(--gold)]/30 flex items-center justify-center relative">
                    ...
                    <div
                      className="w-3 h-3 rounded-full bg-[color:var(--gold)]"
                      style={{ boxShadow: "0 0 30px #D4AF37" }}
                    />
                  </div>
                </div>
              </motion.article>
...
function Mission() {
  const text =
    "Our mission is to drive innovation and build cutting-edge solutions that empower businesses to reach their full potential.";
  const words = text.split(" ");
  return (
...
const SERVICES = [
  {
    n: "01",
    t: "Web Development",
    d: "High-performance, search-optimised web platforms engineered for scale.",
    img: webDevImg,
  },
  {
    n: "02",
    t: "Mobile Development",
    d: "Native and cross-platform applications with cinematic interaction fidelity.",
    img: mobileDevImg,
  },
  {
    n: "03",
    t: "AI & Automation",
    d: "LLM systems, agents, and orchestration that quietly manage your business.",
    img: aiAutomationImg,
  },
  {
    n: "04",
    t: "Cloud Solutions",
    d: "Multi-region and multi-cloud architecture with top-tier observability.",
    img: cloudSolutionsImg,
  },
  {
    n: "05",
    t: "Cybersecurity",
    d: "Enterprise-grade threat modeling, hardening, and continuous monitoring.",
    img: cybersecurityImg,
  },
  {
    n: "06",
    t: "Big Data",
    d: "Pipelines, data lakes, and analytics that transform signals into decisions.",
    img: bigDataImg,
  },
  {
    n: "07",
    t: "Revenue Cycle Management",
    d: "Domain software for healthcare operations and reimbursement workflows.",
    img: rcmBillingImg,
  },
  {
    n: "08",
    t: "Design & Digital Marketing",
    d: "Brand systems, animated identity, and growth engineering in one place.",
    img: designMarketingImg,
  },
  {
    n: "09",
    t: "Crypto · Blockchain · Web3",
    d: "Smart contracts, L2 infrastructure, and tokenised product surfaces.",
    img: blockchainImg,
  },
];
...
function Services() {
  return (
    <section
      id="services"
      className="relative px-6 md:px-12 py-20 md:py-32 bg-[color:var(--space-1)] noise section-divider"
    >
      <div className="max-w-7xl mx-auto">
        <div className="flex items-end justify-between flex-wrap gap-8 mb-12 md:mb-20">
          ...
          <p className="text-[color:var(--muted-foreground)] max-w-md">
            A vertically integrated team - strategy, design, and engineering under one roof,
                ...
                >
                  <div>
                    <div className="flex items-start justify-between">
                      <span className="font-display text-[15px] text-[color:var(--gold)]">
                        {s.n}
                      </span>
                      <div className="w-10 h-10 rounded-full border border-[color:var(--gold)]/20 flex items-center justify-center text-[color:var(--gold)] group-hover:bg-[color:var(--gold)] group-hover:text-[color:var(--space-0)] transition-all">
                        →
                      </div>
                    </div>
                    <div className="my-5 aspect-video w-full rounded-lg overflow-hidden border border-white/5 bg-[color:var(--space-ink)] relative flex items-center justify-center">
                      <img
                        src={s.img}
                        alt={s.t}
                        className="object-cover w-full h-full opacity-60 group-hover:opacity-90 group-hover:scale-105 transition-all duration-700"
                      />
                    </div>
                  </div>
                  <div>
                    <h3 className="font-display text-3xl font-bold tracking-tight">{s.t}</h3>
                    <p className="mt-4 text-[15px] text-[color:var(--muted-foreground)] leading-relaxed">
                      {s.d}
                    </p>
                  </div>
                </motion.div>
  ...
  return (
    <section className="px-6 md:px-12 py-20 md:py-32 bg-[color:var(--space-3)] section-divider">
      <div className="max-w-7xl mx-auto">
        ...
        <Reveal>
          <h2 className="text-section max-w-3xl mb-20">
            An interconnected technological universe.
          </h2>
        </Reveal>
        ...
        <div className="relative aspect-square max-w-3xl mx-auto">
          ...
          {nodes.map((n, i) => (
            ...
            >
              <div
                className={`px-4 py-2 rounded-full border backdrop-blur-md text-[15px] whitespace-nowrap ${i === 0 ? "bg-[color:var(--gold)] text-[color:var(--space-0)] border-[color:var(--gold)] font-semibold" : "border-[color:var(--gold)]/30 bg-[color:var(--space-1)]/80 text-white"}`}
              >
                {n.l}
              </div>
              {i === 0 && (
                <div
                  className="absolute inset-0 rounded-full animate-[pulse-gold_3s_ease-in-out_infinite]"
                  style={{ boxShadow: "0 0 40px #D4AF37" }}
                />
              )}
            </motion.div>
          ))}
...
function Why() {
  const items = [
    {
      t: "Innovation",
      d: "Pioneering creative technologies and novel approaches to solve complex product challenges.",
    },
    {
      t: "Scalability",
      d: "Architected to handle sudden traffic surges and massive growth without performance drops.",
    },
    {
      t: "Security",
      d: "Hardened defense, threat modeling, and continuous compliance built-in from day one.",
    },
    {
      t: "Automation",
      d: "Replacing repetitive, manual workflows with intelligent, self-repairing background systems.",
    },
    {
      t: "Expert Team",
      d: "Senior developers and domain engineers who own the product lifecycle end-to-end.",
    },
    {
      t: "Future-proof Solutions",
      d: "Leveraging modern tech stacks that adapt seamlessly to evolving business needs.",
    },
  ];
  return (
    <section className="px-6 md:px-12 py-20 md:py-32 bg-[color:var(--space-4)] section-divider">
      <div className="max-w-7xl mx-auto">
        ...
        <Reveal>
          <h2 className="text-section mb-12 md:mb-20 max-w-3xl">
            Six reasons why studios and CTOs choose us.
          </h2>
        </Reveal>
        <div className="divide-y divide-white/5 border-y border-white/5">
          {items.map((item, i) => (
            <Reveal key={item.t} delay={i * 0.04}>
              <div className="py-10 grid md:grid-cols-12 gap-6 items-center group hover:bg-white/[0.02] transition-colors px-2">
                ...
                <div className="md:col-span-7 font-display text-3xl md:text-5xl font-bold group-hover:text-[color:var(--gold)] transition-colors">
                  {item.t}
                </div>
...
function Contact() {
  return (
    <section
      id="contact"
      className="px-6 md:px-12 py-20 md:py-32 bg-[color:var(--space-2)] section-divider"
    >
      <div className="max-w-6xl mx-auto">
...
function FinalCTA() {
  return (
    <section className="relative px-6 md:px-12 py-24 md:py-48 overflow-hidden noise">
      {/* radial explosion */}
      <div
        className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[120vw] h-[120vw] rounded-full"
        style={{
          background:
            "radial-gradient(circle, rgba(212,175,55,0.22) 0%, rgba(212,175,55,0.05) 18%, transparent 50%)",
        }}
      />
      {[1, 2, 3, 4, 5].map((i) => (
        <motion.div
